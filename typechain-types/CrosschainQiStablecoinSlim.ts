...
export interface CrosschainQiStablecoinSlimInterface extends utils.Interface {
...
export interface CrosschainQiStablecoinSlim extends BaseContract {
  ...
  interface: CrosschainQiStablecoinSlimInterface;
  ...
  callStatic: {
    ...
    burn(amountToken: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    setTokenURI(_uri: string, overrides?: CallOverrides): Promise<void>;
